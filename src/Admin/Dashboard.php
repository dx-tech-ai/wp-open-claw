...
class Dashboard {
    ...
    public function render_command_palette_container(): void {
        ...
        ?>
        <div id="wpoc-command-palette" class="wpoc-overlay" style="display:none;" role="dialog" aria-label="<?php esc_attr_e('Open Claw Command Palette', 'wp-open-claw'); ?>">
            ...
            <div class="wpoc-palette">
                ...
                <div class="wpoc-footer">
                    ...
                    <span class="wpoc-status" id="wpoc-status"><?php esc_html_e('Ready', 'wp-open-claw'); ?></span>
                </div>
            </div>
        </div>
        <?php
